...
create table insurance_claims (
    ...
    current_operation varchar(32) not null,
    region_code varchar(64) not null,
    insurance_type_code varchar(64) not null,
    payer_name_snapshot varchar(300) not null,
    organization_code varchar(128) not null,
    department_code varchar(128) not null,
    practitioner_code varchar(128) not null,
    diagnosis_payload_digest varchar(128) not null,
    service_started_at timestamp with time zone not null,
    service_ended_at timestamp with time zone,
    external_pre_settlement_no varchar(128),
    external_settlement_no varchar(128),
    gross_amount decimal(24,6) not null,
    insurance_fund_amount decimal(24,6) not null,
    personal_account_amount decimal(24,6) not null,
    patient_cash_amount decimal(24,6) not null,
    other_fund_amount decimal(24,6) not null,
...
create table insurance_claim_lines (
    ...
    insurance_item_code varchar(128) not null,
...
create table insurance_claim_responses (
    ...
    response_no varchar(128) not null,
    command_code varchar(128) not null,
