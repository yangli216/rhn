alter table RHN_BIL_CHARGE_ITEM add column ID_ORG bigint;
alter table RHN_BIL_CHARGE_ITEM add column ID_DEPT bigint;
...
alter table RHN_BIL_CHARGE_ITEM alter column ID_ORG set not null;
alter table RHN_BIL_CHARGE_ITEM alter column ID_DEPT set not null;
