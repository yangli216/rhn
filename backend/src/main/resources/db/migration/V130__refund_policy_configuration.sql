-- Parameter baseline for outpatient collaborative refund and unexecuted direct refund.
insert into parameter_categories values (
    362387869794050, null, 'BILLING', '收费与结算',
    '门诊收费、住院结算、预交金与退费等财务业务策略', 30, true, 0,
...
insert into parameter_categories values (
    ...
    '控制未发药未执行医嘱直接退费与退费协同审批防损策略', 10, true, 0,
    current_timestamp, 362387869790222, current_timestamp, 362387869790222
);
...
insert into parameter_changes (
    ...
    '{"source":"PRODUCT_BASELINE","key":"billing.refund.unexecuted-direct-refund.enabled","status":"ACTIVE"}',
