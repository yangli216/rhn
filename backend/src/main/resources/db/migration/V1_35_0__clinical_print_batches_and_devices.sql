create table RHN_META_PRINT_DEVICE (
    ID_PRINT_DEVICE bigint primary key,
...
create table RHN_META_PRINT_DEV_BIND (
    ID_PRINT_DEV_BIND bigint primary key,
    REVISION bigint default 0 not null,
    ID_TNT bigint not null,
    ...
    ID_PRINT_DEVICE bigint not null,
    FG_DEFAULT boolean default true not null,
    SD_STATUS varchar(24) not null,
    DT_CREATED timestamp with time zone not null,
    ID_USER_CREATED bigint,
    DT_UPDATED timestamp with time zone not null,
...
create table RHN_SYS_PRINT_BATCH (
    ID_PRINT_BATCH bigint primary key,
    REVISION bigint default 0 not null,
    ID_TNT bigint not null,
    ID_ORG bigint not null,
    ID_DEPT bigint not null,
    ...
    ID_PRINT_MEDIA bigint not null,
    ID_PRINT_DEVICE bigint,
    DA_BUSINESS date not null,
    JSON_SELECTION clob not null,
    SD_LAYOUT_STRATEGY varchar(32) not null,
    SN_START_SLOT integer default 1 not null,
    ID_IDEMPOTENCY varchar(128) not null,
    SD_STATUS varchar(32) not null,
    QTY_SELECTED integer default 0 not null,
    QTY_INCLUDED integer default 0 not null,
    QTY_EXCLUDED integer default 0 not null,
    QTY_PAGES integer default 0 not null,
...
create table RHN_SYS_PRINT_BATCH_ITEM (
    ID_PRINT_BATCH_ITEM bigint primary key,
    ID_TNT bigint not null,
    ID_PRINT_BATCH bigint not null,
...
create table RHN_SYS_PRINT_DELIVERY (
    ID_PRINT_DELIVERY bigint primary key,
    REVISION bigint default 0 not null,
    ID_TNT bigint not null,
    ID_PRINT_BATCH bigint not null,
    ID_PRINT_JOB bigint not null,
    ID_PRINT_DEVICE bigint,
    SD_CHANNEL varchar(24) not null,
    SD_STATUS varchar(32) not null,
