create table RHN_META_PRINT_TASK_DEF (
    ID_PRINT_TASK_DEF bigint primary key,
    REVISION bigint default 0 not null,
    CD_TASK varchar(100) not null,
    NA_TASK varchar(200) not null,
    SD_CATEGORY varchar(32) not null,
    SD_SOURCE_TYPE varchar(80) not null,
    CD_DATA_PROVIDER varchar(80) not null,
    CD_PAYLOAD_SCHEMA varchar(100) not null,
    SN_SCHEMA_VER integer not null,
    JSON_PURPOSES clob not null,
    FG_BATCH boolean default false not null,
...
create table RHN_META_PRINT_IMPL (
    ID_PRINT_IMPL bigint primary key,
    REVISION bigint default 0 not null,
    ID_TNT bigint,
    CD_IMPL varchar(100) not null,
    NA_IMPL varchar(200) not null,
    SD_RENDERER varchar(32) not null,
    CD_ADAPTER varchar(80) not null,
    ID_PRINT_TMPL bigint,
    CD_PAYLOAD_SCHEMA varchar(100) not null,
    SD_OUTPUT_FORMAT varchar(24) not null,
...
create table RHN_META_PRINT_IMPL_BIND (
    ID_PRINT_IMPL_BIND bigint primary key,
    REVISION bigint default 0 not null,
    ID_TNT bigint,
    ID_ORG bigint,
    ID_DEPT bigint,
    ID_PRINT_TASK_DEF bigint not null,
    SD_PURPOSE varchar(40) not null,
    ID_PRINT_IMPL bigint not null,
    SD_SCOPE varchar(24) not null,
    SD_FALLBACK varchar(24) not null,
...
alter table RHN_SYS_PRINT_OUTPUT add column ID_PRINT_TASK_DEF bigint;
alter table RHN_SYS_PRINT_OUTPUT add column CD_PRINT_TASK varchar(100);
alter table RHN_SYS_PRINT_OUTPUT add column ID_PRINT_IMPL bigint;
alter table RHN_SYS_PRINT_OUTPUT add column ID_PRINT_IMPL_BIND bigint;
alter table RHN_SYS_PRINT_OUTPUT add column CD_PAYLOAD_SCHEMA varchar(100);
...
insert into RHN_META_PRINT_TASK_DEF values (270000000000301, 0, 'OP.MEDICAL_RECORD.PRINT', '门诊病历打印', 'CLINICAL_DOCUMENT', 'ClinicalDocument', 'CLINICAL_DOCUMENT', 'RHN.PRINT.OUTPATIENT_NOTE.V1', 1, '["CLINICAL_USE","PATIENT_COPY","ARCHIVE_COPY"]', false, 'ACTIVE', current_timestamp, null, current_timestamp, null);
insert into RHN_META_PRINT_TASK_DEF values (270000000000302, 0, 'OP.PRESCRIPTION.WESTERN.PRINT', '门诊西药处方打印', 'PRESCRIPTION', 'Prescription', 'PRESCRIPTION', 'RHN.PRINT.OUTPATIENT_PRESCRIPTION.V1', 1, '["PATIENT_COPY","ARCHIVE_COPY"]', false, 'ACTIVE', current_timestamp, null, current_timestamp, null);
insert into RHN_META_PRINT_TASK_DEF values (270000000000303, 0, 'OP.APPLICATION.LAB.PRINT', '检验申请单打印', 'APPLICATION', 'ServiceRequest', 'SERVICE_REQUEST', 'RHN.PRINT.LABORATORY_APPLICATION.V1', 1, '["CLINICAL_USE","PATIENT_COPY","ARCHIVE_COPY"]', false, 'ACTIVE', current_timestamp, null, current_timestamp, null);
insert into RHN_META_PRINT_TASK_DEF values (270000000000304, 0, 'OP.APPLICATION.EXAM.PRINT', '检查申请单打印', 'APPLICATION', 'ServiceRequest', 'SERVICE_REQUEST', 'RHN.PRINT.EXAMINATION_APPLICATION.V1', 1, '["CLINICAL_USE","PATIENT_COPY","ARCHIVE_COPY"]', false, 'ACTIVE', current_timestamp, null, current_timestamp, null);
insert into RHN_META_PRINT_TASK_DEF values (270000000000305, 0, 'OP.APPLICATION.TREATMENT.PRINT', '治疗申请单打印', 'APPLICATION', 'ServiceRequest', 'SERVICE_REQUEST', 'RHN.PRINT.TREATMENT_APPLICATION.V1', 1, '["CLINICAL_USE","PATIENT_COPY","ARCHIVE_COPY"]', false, 'ACTIVE', current_timestamp, null, current_timestamp, null);
insert into RHN_META_PRINT_TASK_DEF values (270000000000306, 0, 'TREATMENT.ORAL_MEDICATION_CARD.PRINT', '口服药卡打印', 'CARD', 'MedicationExecutionTask', 'TREATMENT_EXECUTION', 'RHN.PRINT.ORAL_MEDICATION_CARD.V1', 1, '["CLINICAL_USE"]', true, 'ACTIVE', current_timestamp, null, current_timestamp, null);
insert into RHN_META_PRINT_TASK_DEF values (270000000000307, 0, 'TREATMENT.INFUSION_LABEL.PRINT', '输液瓶签打印', 'LABEL', 'MedicationExecutionTask', 'TREATMENT_EXECUTION', 'RHN.PRINT.INFUSION_LABEL.V1', 1, '["CLINICAL_USE"]', true, 'ACTIVE', current_timestamp, null, current_timestamp, null);
insert into RHN_META_PRINT_TASK_DEF values (270000000000308, 0, 'TREATMENT.INFUSION_PATROL_CARD.PRINT', '输液巡视卡打印', 'CARD', 'MedicationExecutionTask', 'TREATMENT_EXECUTION', 'RHN.PRINT.INFUSION_PATROL_CARD.V1', 1, '["CLINICAL_USE"]', true, 'ACTIVE', current_timestamp, null, current_timestamp, null);
