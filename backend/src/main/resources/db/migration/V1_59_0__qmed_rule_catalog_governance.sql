create table RHN_AUD_MED_GOV (
    ID_RULE_GOV bigint not null,
    ID_TNT bigint not null,
    CD_RULE_KEY varchar(100) not null,
...
create table RHN_AUD_MED_GOV_RUN (
    ID_RULE_RUN bigint not null,
    ID_TNT bigint not null,
    CD_RULE_KEY varchar(100) not null,
    CD_VERSION varchar(100) not null,
    SD_MODE varchar(20) not null,
    SD_DECISION varchar(32) not null,
