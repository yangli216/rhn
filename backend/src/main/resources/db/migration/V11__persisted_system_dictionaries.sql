alter table dictionary_definitions add column system_managed boolean default false not null;
alter table dictionary_definitions alter column created_by drop not null;
alter table dictionary_definitions alter column updated_by drop not null;
alter table dictionary_definitions add constraint ck_dictionary_definition_management check (
    ...
    (system_managed = false and created_by is not null and updated_by is not null)
);
