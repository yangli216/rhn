create table RHN_META_PRINT_DOC_DEF (
    ID_PRINT_DOC_DEF bigint primary key,
    ID_TNT bigint,
    CD_DOC_TYPE varchar(80) not null,
    NA_DOC varchar(200) not null,
    SD_DOC_CAT varchar(32) not null,
    SD_LAYOUT_MODE varchar(16) not null,
    JSON_DATA_SCHEMA varchar(80) not null,
...
create table RHN_META_PRINT_MEDIA (
    ID_PRINT_MEDIA bigint primary key,
    ID_TNT bigint,
    CD_MEDIA varchar(80) not null,
    NA_MEDIA varchar(200) not null,
    SD_MEDIA_KIND varchar(24) not null,
    WIDTH_MM decimal(8,2) not null,
    HEIGHT_MM decimal(8,2),
    SD_ORIENTATION varchar(16) not null,
    MARGIN_TOP_MM decimal(8,2) default 0 not null,
    MARGIN_RIGHT_MM decimal(8,2) default 0 not null,
    MARGIN_BOTTOM_MM decimal(8,2) default 0 not null,
    MARGIN_LEFT_MM decimal(8,2) default 0 not null,
    GAP_HORIZONTAL_MM decimal(8,2) default 0 not null,
    GAP_VERTICAL_MM decimal(8,2) default 0 not null,
    QTY_COLUMNS integer default 1 not null,
    QTY_ROWS integer default 1 not null,
    QTY_DPI integer default 300 not null,
    SD_SENSOR_MODE varchar(16) default 'NONE' not null,
    SD_STATUS varchar(24) not null,
    REVISION bigint default 0 not null,
    DT_CREATED timestamp with time zone not null,
    ID_USER_CREATED bigint,
...
create table RHN_META_PRINT_DRAFT (
    ID_PRINT_DRAFT bigint primary key,
    ID_TNT bigint not null,
    ID_PRINT_TMPL bigint,
    ID_PRINT_DOC_DEF bigint not null,
    ID_PRINT_MEDIA bigint not null,
    ID_PRINT_TMPL_VER_PUBLISD bigint,
...
alter table RHN_META_PRINT_TMPL_VER add column ID_PRINT_DOC_DEF bigint;
alter table RHN_META_PRINT_TMPL_VER add column ID_PRINT_MEDIA bigint;
