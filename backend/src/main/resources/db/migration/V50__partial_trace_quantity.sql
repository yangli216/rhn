alter table inventory_trace_codes add remaining_base_quantity decimal(28,8) default 0 not null;
...
alter table inventory_trace_events add quantity_delta decimal(28,8) default 0 not null;
alter table inventory_trace_events add balance_after decimal(28,8) default 0 not null;
