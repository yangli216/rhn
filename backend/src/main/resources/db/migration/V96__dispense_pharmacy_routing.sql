create table dispense_routes (
    ...
    medication_type varchar(32),
    target_stock_site_id bigint not null,
...
alter table pharmacy_fulfillment_authorizations add column dispense_route_id bigint;
alter table pharmacy_fulfillment_authorizations add column dispense_route_revision bigint;
alter table pharmacy_fulfillment_authorizations add column routed_stock_site_id bigint;
alter table pharmacy_fulfillment_authorizations add column routed_at timestamp with time zone;
