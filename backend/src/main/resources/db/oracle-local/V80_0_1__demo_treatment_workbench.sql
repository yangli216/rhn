insert into catalog_items (
    ...
    1, 1, 0, 'ACTIVE', date '2026-01-01', null, current_timestamp, 362387869790222,
...
insert into service_items (
    ...
    362387869795105, 362387869790209, 'TREATMENT', 'INJECTION', 'OUTPATIENT', 0,
    0, 1, null, null, 'TREATMENT', 0, '执行前核对患者身份及用药信息', null
);
...
insert into organization_catalog_items (
    ...
    362387869790212, 'OPD-INJ', '门诊注射', 1, 1, 1, 0, 0, 0, 0,
...
insert into catalog_prices (
    ...
    'SALE', 6.00, 'CNY', 'DEMO-PRICE-2026', '基层门诊治疗体验数据', date '2026-01-01', null,
...
insert into catalog_items (
    ...
    1, 1, 1, 'ACTIVE', date '2026-01-01', null, current_timestamp, 362387869790222,
...
insert into medications (
    ...
    'WESTERN', 'INJECTION', '100mg/2ml', '支', 100, 'mg', 1, 1, 0, 0,
...
values (362387869795204, 362387869790209, '维生素B1', 'VITAMIN', 0, 0);
...
insert into medication_products (
    ...
    '维生素B1注射液', '国药准字H00000004', 0, 0, 0, 0, '维生素B1缺乏的辅助治疗'
);
...
insert into item_packages (
    ...
    1, 'DISPENSE', '6900000000014', 1, 1, 1, 'ACTIVE', date '2026-01-01', null
);
...
insert into organization_catalog_items (
    ...
    362387869790212, 'P-VB1-INJ', '维生素B1注射液', 1, 0, 1, 1, 1, 1, 1,
    'ACTIVE', date '2026-01-01', null, current_timestamp, 362387869790222,
    current_timestamp, 362387869790222, null
);
...
insert into catalog_prices (
    ...
    'SALE', 1.20, 'CNY', 'DEMO-PRICE-2026', '基层门诊治疗体验数据', date '2026-01-01', null,
    'ACTIVE', current_timestamp, 362387869790222, current_timestamp, 362387869790222, null
);
...
insert into stock_items (
    ...
    362387869795404, '支', 'FEFO', 0, 1, 0, 0, 0, 0, null, 0,
