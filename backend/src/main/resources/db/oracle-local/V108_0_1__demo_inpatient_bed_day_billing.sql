insert into catalog_items (
    ...
    0, 1, 0, 'ACTIVE', date '2026-01-01', null, current_timestamp, 362387869790222,
...
insert into service_items (
    ...
    362387869898520, 362387869790209, 'OTHER', 'BED_DAY', 'INPATIENT', 0,
    0, 1, 'BED', 0
);
...
insert into organization_catalog_items (
    ...
    362387869898501, 'BED-DAY', '普通床位费', 0, 0, 1, 0, 0, 0, 0,
