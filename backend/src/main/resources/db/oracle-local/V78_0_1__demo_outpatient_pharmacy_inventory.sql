insert into stock_items (
    ...
    362387869795403, '片', 'FEFO', 0, 1, 0, 1, 0, 0, null, 0,
...
insert into stock_bins (
    ...
    1, 1, 1, 10, 1, current_timestamp, 362387869790222
);
...
insert into inventory_transaction_lines (
    ...
    (select id from stock_items
     where tenant_id = 362387869790209
       and stock_site_id = 362387869799502
       and catalog_item_id = 362387869795113),
    362387869799603, 362387869795403,
...
insert into inventory_balances (
    ...
    (select id from stock_items
     where tenant_id = 362387869790209
       and stock_site_id = 362387869799502
       and catalog_item_id = 362387869795113),
    362387869799603, 'AVAILABLE', '片', 1400, 0, 0, 1400,
