...
update laboratory_services set laboratory_method = 'BIOCHEMISTRY', fasting_required = 1
...
insert into laboratory_service_specimens (
    ...
    362387869797301, 362387869790209, 362387869795101, 362387869797111,
    362387869797121, 2, 'mL', 1, 1, 10, '采集抗凝全血并充分混匀。', 'ACTIVE'
);
insert into laboratory_service_specimens (
    id, tenant_id, catalog_item_id, specimen_item_id, container_item_id,
    minimum_quantity, minimum_quantity_unit, default_specimen, required_specimen,
    ...
    362387869797302, 362387869790209, 362387869795102, 362387869797112,
    362387869797122, 2, 'mL', 1, 1, 10, '按临床要求空腹采集血清。', 'ACTIVE'
);

update examination_services
set examination_type = 'ULTRASOUND', body_site_required = 1, preparation_description = '检查前按申请要求空腹。'
