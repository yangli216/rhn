...
insert into service_items (
    ...
    362387869795104, 362387869790209, 'PROCEDURE', 'OUTPATIENT_VISIT', 'OUTPATIENT', 0,
    0, 1, null, null, 'REGISTRATION', 0, '用于基层全科门诊排班与挂号', null
);
...
insert into organization_catalog_items (
    ...
    (362387869795504, 0, 362387869790209, 362387869790211, 362387869795104,
     362387869790212, 'OPD-GP', '全科门诊', 1, 1, 1, 0, 0, 0, 0,
...
insert into catalog_prices (
    ...
    (362387869795604, 0, 362387869790209, 362387869795104, 362387869790211, null,
     'SALE', 10.00, 'CNY', 'DEMO-PRICE-2026', '基层全科门诊体验挂号费', date '2026-01-01', null,
