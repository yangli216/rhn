insert into management_modules (
    id, tenant_id, parent_id, code, name, module_type, route_path,
    component_code, icon_code, sort_order, status, created_at, updated_at, version
) values (
    362387869896026, 362387869790209, 362387869896012, 'PHARMACY_ROUTE', '发药药房设置', 'MODULE',
    '/settings/dispense-routes', 'DispenseRouteSettings', 'pharmacy', 55, 'ACTIVE',
...
insert into dispense_routes (
    id, revision, tenant_id, organization_id, code, name, source_department_id,
    medication_type, target_stock_site_id, active, valid_from, valid_to,
    ...
    '中药饮片发往中药房', null, 'HERBAL', 362387869799504, 1, date '2026-01-01', null,
    '机构内中药饮片及配方颗粒统一由中药房调剂发药', current_timestamp,
...
insert into dispense_routes (
    ...
    '门诊药品默认发药药房', null, null, 362387869799502, 1, date '2026-01-01', null,
    '未命中专项规则的门诊药品统一流向门诊药房', current_timestamp,
    362387869790222, current_timestamp, 362387869790222
)
/
