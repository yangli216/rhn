...
alter table RHN_META_PRINT_DEVICE alter column JSON_CAPABILITIES clob;
comment on column RHN_META_PRINT_DEVICE.JSON_CAPABILITIES is '设备能力JSON';

alter table RHN_SYS_PRINT_BATCH alter column JSON_SELECTION clob;
comment on column RHN_SYS_PRINT_BATCH.JSON_SELECTION is '选择条件快照JSON';

alter table RHN_SYS_PRINT_BATCH_ITEM alter column JSON_SNAPSHOT clob;
comment on column RHN_SYS_PRINT_BATCH_ITEM.JSON_SNAPSHOT is '不可变打印快照JSON';

alter table RHN_META_PRINT_TASK_DEF alter column JSON_PURPOSES clob;
