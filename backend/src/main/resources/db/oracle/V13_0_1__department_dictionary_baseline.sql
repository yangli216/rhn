insert into dictionary_definitions (
    ...
    0, 'ACTIVE', current_timestamp, null, current_timestamp, null
);
...
insert into dictionary_definitions (
    ...
    '科室在机构内的管理和业务属性', 0, 'ACTIVE', current_timestamp, null, current_timestamp, null
);
...
insert into dictionary_definitions (
    ...
    '不改变科室权威父树的业务关系', 0, 'ACTIVE', current_timestamp, null, current_timestamp, null
);
...
insert into dictionary_definitions (
    ...
    '科室可承担的主要业务能力', 0, 'ACTIVE', current_timestamp, null, current_timestamp, null
);
...
insert into dictionary_definitions (
    ...
    '科主任、副主任、护士长及专项责任人', 0, 'ACTIVE', current_timestamp, null, current_timestamp, null
);
