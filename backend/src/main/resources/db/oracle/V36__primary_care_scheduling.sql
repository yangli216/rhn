...
create table service_resources (
    ...
    resource_name varchar2(300 char) not null,
    service_code_snapshot varchar2(64 char) not null,
...
create table schedule_templates (
    ...
    template_code varchar2(128 char) not null,
    template_name varchar2(300 char) not null,
    management_mode varchar2(32 char) not null,
    timezone_code varchar2(64 char) not null,
...
create table schedule_template_periods (
    ...
    day_part varchar2(32 char) not null,
    minute_start number(10) not null,
    minute_end number(10) not null,
    default_capacity number(10) not null,
    slot_mode varchar2(32 char) not null,
...
create table schedule_generation_runs (
    ...
    trigger_type varchar2(32 char) not null,
    status varchar2(32 char) not null,
    ...
    triggered_by number(19) not null,
...
create table service_schedules (
    ...
    resource_id number(19) not null,
    template_id number(19) not null,
    template_period_id number(19) not null,
    generation_run_id number(19) not null,
    organization_id number(19) not null,
    department_id number(19) not null,
    practitioner_id number(19) not null,
    assignment_id number(19) not null,
    catalog_item_id number(19) not null,
    schedule_code varchar2(128 char) not null,
    management_mode varchar2(32 char) not null,
    schedule_type varchar2(32 char) not null,
    booking_policy varchar2(32 char) not null,
    day_part varchar2(32 char) not null,
...
create unique index uk_service_schedule_time on service_schedules
    (tenant_id, resource_id, sys_extract_utc(start_at), sys_extract_utc(end_at));
...
create table schedule_slot_pools (
    ...
    pool_code varchar2(128 char) not null,
    slot_mode varchar2(32 char) not null,
    quota_mode varchar2(32 char) not null,
    total_count number(10) not null,
    held_count number(10) default 0 not null,
    occupied_count number(10) default 0 not null,
    frozen_count number(10) default 0 not null,
    status varchar2(32 char) not null,
    created_at timestamp with time zone not null,
    updated_at timestamp with time zone not null,
...
create table slot_events (
    id number(19) primary key,
    tenant_id number(19) not null,
    pool_id number(19) not null,
    schedule_id number(19) not null,
    event_type varchar2(32 char) not null,
    sequence_no number(10) not null,
    total_delta number(10) default 0 not null,
    held_delta number(10) default 0 not null,
    occupied_delta number(10) default 0 not null,
    frozen_delta number(10) default 0 not null,
    command_code varchar2(128 char) not null,
    actor_user_id number(19) not null,
    occurred_at timestamp with time zone not null,
    description varchar2(1000 char),
...
insert into parameter_categories values (
    ...
    '基层简易排班与专业排班共用的模式、周期和默认时段参数', 10, 1, 0,
    current_timestamp, 362387869790222, current_timestamp, 362387869790222
);
...
insert into parameter_definitions values (
    ...
    'SC_SCHEDULE_MANAGEMENT_MODE', '["PLATFORM","TENANT","ORGANIZATION","DEPARTMENT"]', 'BUSINESS', 1, 1, 0,
...
insert into parameter_definitions values (
    ...
    'NUMBER', 'NUMBER', '{"type":"number(10)","minimum":1,"maximum":500}', '50', '30', 'count', null,
...
insert into parameter_definitions values (
    ...
    'NUMBER', 'NUMBER', '{"type":"number(10)","minimum":1,"maximum":90}', '28', '14', 'd', null,
