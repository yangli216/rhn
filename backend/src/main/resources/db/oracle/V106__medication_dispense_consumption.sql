...
alter table inpatient_order_workflows add (
    medication_quantity_per_occurrence number(28,8),
    medication_quantity_unit varchar2(64 char),
    medication_base_quantity_per_occurrence number(28,8),
    medication_base_unit varchar2(64 char),
    constraint ck_ip_wf_med_supply check (
...
create table inpatient_med_consumptions (
    ...
    dispense_line_id number(19) not null,
    consumed_quantity number(28,8) not null,
    dispense_unit_code varchar2(64 char) not null,
    consumed_base_quantity number(28,8) not null,
    base_unit_code varchar2(64 char) not null,
    command_code varchar2(128 char) not null,
    consumed_at timestamp with time zone not null,
    consumed_by number(19) not null,
