-- Oracle variant of db/migration/V117. Identifiers stay within Oracle's 30-character limit.
alter table inpatient_med_supply_gen_runs add (
    medication_type_snapshot varchar2(32 char) default '*' not null,
    last_error_code varchar2(64 char)
)
/

alter table inpatient_med_supply_gen_runs modify (
    stock_site_id null,
    dispense_route_id null,
    dispense_route_revision null
)
/
...
alter table inpatient_med_supply_batches add (
    ...
    medication_type_snapshot varchar2(32 char)
)
/
