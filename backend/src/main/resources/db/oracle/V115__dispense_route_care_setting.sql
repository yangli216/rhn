-- Oracle variant of db/migration/V115.
alter table dispense_routes add (care_setting varchar2(32 char))
/
update dispense_routes set care_setting = 'OUTPATIENT' where care_setting is null
/
alter table dispense_routes modify (care_setting not null)
/
...
select 362387869899603, 0, 362387869790209, 362387869790211,
       'INPATIENT-GENERAL-WARD', '住院病区默认发药药房', 'INPATIENT',
       362387869898501, null, 362387869799503, 1, date '2026-01-01', null,
