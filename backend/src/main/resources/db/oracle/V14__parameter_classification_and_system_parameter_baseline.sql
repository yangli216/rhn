...
-- Oracle variant of db/migration/V14.
...
insert into parameter_categories (
    ...
    '跨业务共享的平台运行能力；不承载具体条线业务策略', 10, 1, 0,
...
insert into parameter_definitions values (
    ...
    '["PLATFORM","TENANT","USER"]', 'SYSTEM', 1, 1, 0,
    'NORMAL', 'PLAIN', 'ACTIVE', 0, current_timestamp, 362387869790222, current_timestamp, 362387869790222
);
...
insert into parameter_definitions values (
    ...
    '["PLATFORM","TENANT","ORGANIZATION","USER"]', 'SYSTEM', 1, 1, 0,
    'NORMAL', 'PLAIN', 'ACTIVE', 0, current_timestamp, 362387869790222, current_timestamp, 362387869790222
);
...
insert into parameter_definitions values (
    ...
    '["PLATFORM","TENANT","ORGANIZATION"]', 'SYSTEM', 1, 0, 0,
    'NORMAL', 'PLAIN', 'ACTIVE', 0, current_timestamp, 362387869790222, current_timestamp, 362387869790222
);
