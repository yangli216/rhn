...
insert into dictionary_definitions (
    ...
    'RC038 国家公立医院绩效考核患者证件类别代码', 0, 'ACTIVE', current_timestamp, 362387869790222,
...
insert into dictionary_definitions (
    ...
    'GB/T 2659-2000 世界各国和地区名称代码', 0, 'ACTIVE', current_timestamp, 362387869790222,
    current_timestamp, 362387869790222, 362387869841000);
...
insert into dictionary_definitions (
    ...
    'GB/T 3304-1991 中国各民族名称的罗马字母拼写法和代码', 0, 'ACTIVE', current_timestamp, 362387869790222,
    current_timestamp, 362387869790222, 362387869841000);
...
insert into dictionary_definitions (
    ...
    'GB 4658-2006 学历代码（大类）', 0, 'ACTIVE', current_timestamp, 362387869790222,
    current_timestamp, 362387869790222, 362387869841000);
...
insert into dictionary_definitions (
    ...
    'GB/T 2261.4-2003 个人基本信息分类与代码 第4部分：从业状况代码', 0, 'ACTIVE', current_timestamp, 362387869790222,
    current_timestamp, 362387869790222, 362387869841000);
...
insert into dictionary_definitions (
    ...
    'GB/T 6565-2015 职业分类与代码', 0, 'ACTIVE', current_timestamp, 362387869790222,
    current_timestamp, 362387869790222, 362387869841000);
...
insert into dictionary_definitions (
    ...
    'GB/T 4766-1984 婚姻状况代码', 0, 'ACTIVE', current_timestamp, 362387869790222,
    current_timestamp, 362387869790222, 362387869841000);
...
insert into dictionary_definitions (
    ...
    'GB/T 4761-2008 家庭关系代码', 0, 'ACTIVE', current_timestamp, 362387869790222,
    current_timestamp, 362387869790222, 362387869841000);
...
insert into dictionary_definitions (
    ...
    'CV07.10.003-2022 江苏扩展码', 0, 'ACTIVE', current_timestamp, 362387869790222,
    current_timestamp, 362387869790222, 362387869841000);
