...
public class ExaminationService {
    ...
    @Column(name = "DES_PREP_DESCR") private String preparationDescription;
    @Column(name = "SD_SITE_PRICING_MODE", nullable = false) private String sitePricingMode;
    @Column(name = "QTY_INCLD_SITE", nullable = false) private int includedSiteCount;
    ...
    @Column(name = "QTY_MAX_CHGBL_SITE") private Integer maxChargeableSiteCount;
