...
public class OrderFrequency {
    ...
    @Column(name = "DEFAULT_EXEC_TIMES") private String defaultExecutionTimes;
    @Column(name = "FG_OP_APPL", nullable = false) private boolean outpatientApplicable;
    @Column(name = "FG_INP_APPL", nullable = false) private boolean inpatientApplicable;
    @Column(name = "FG_EMERG_APPL", nullable = false) private boolean emergencyApplicable;
    @Column(name = "FG_MED_APPL", nullable = false) private boolean medicationApplicable;
    @Column(name = "FG_TREAT_APPL", nullable = false) private boolean treatmentApplicable;
    @Column(name = "FG_NURS_APPL", nullable = false) private boolean nursingApplicable;
    @Column(name = "FG_AUTO_TASK_GEN", nullable = false) private boolean automaticTaskGeneration;
