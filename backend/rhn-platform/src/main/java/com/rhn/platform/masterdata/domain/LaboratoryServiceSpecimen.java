...
public class LaboratoryServiceSpecimen {
    ...
    @Column(name = "ID_DICT_ITEM_CONTNR") private Long containerItemId;
    @Column(name = "QTY_MINIMUM") private BigDecimal minimumQuantity;
    @Column(name = "MINIMUM_QTY_UNIT") private String minimumQuantityUnit;
    @Column(name = "FG_DEFAULT_SPEC", nullable = false) private boolean defaultSpecimen;
    @Column(name = "FG_RQD_SPEC", nullable = false) private boolean requiredSpecimen;
    ...
    @Column(name = "QTY_INCLD_TUBE", nullable = false) private int includedTubeCount;
