...
public class OrganizationCatalogItem {
    ...
    @Column(name = "FG_EXECBL", nullable = false) private boolean executable;
    @Column(name = "FG_CHGBL", nullable = false) private boolean chargeable;
    @Column(name = "FG_PURCHBL", nullable = false) private boolean purchasable;
    @Column(name = "FG_STOCKED", nullable = false) private boolean stocked;
    @Column(name = "FG_DISPBL", nullable = false) private boolean dispensable;
    @Column(name = "FG_RETBL", nullable = false) private boolean returnable;
    ...
    @Column(name = "ID_ORG_CATALOG_ITEM_RPLCD") private Long replacesAdoptionId;
