...
public class ExternalMessage {
    ...
    @Column(name = "CD_ENDPT", nullable = false) private String endpointCode;
    ...
    @Column(name = "ID_BIZ_MSG", nullable = false) private String businessMessageId;
    ...
    @Column(name = "PAYLOAD_DIGEST_ALGO", nullable = false) private String payloadDigestAlgorithm;
    ...
    @Column(name = "DT_PROCSD") private Instant processedAt;
