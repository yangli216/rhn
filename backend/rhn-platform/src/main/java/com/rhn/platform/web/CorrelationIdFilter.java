...
public class CorrelationIdFilter extends OncePerRequestFilter {
    public static final String HEADER_NAME = com.rhn.shared.api.CorrelationIds.HEADER_NAME;
    public static final String ATTRIBUTE_NAME = com.rhn.shared.api.CorrelationIds.ATTRIBUTE_NAME;
