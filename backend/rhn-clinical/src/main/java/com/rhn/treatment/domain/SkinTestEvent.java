...
public class SkinTestEvent {
    ...
    @Column(name = "NA_SOLN_SNAP", length = 300) private String solutionNameSnapshot;
    @Column(name = "ID_STOCK_LOT") private Long stockLotId;
    @Column(name = "CD_LOT_SNAP", length = 128) private String lotNoSnapshot;
    @Column(name = "CONC", precision = 28, scale = 8) private BigDecimal concentration;
    @Column(name = "CONC_UNIT", length = 64) private String concentrationUnit;
    @Column(name = "BODY_SITE", length = 128) private String bodySite;
    @Column(name = "SD_VRFCTN_METHOD", nullable = false) private String verificationMethod;
    ...
    @Column(name = "QTY_WHEAL_DIAM_MM", precision = 8, scale = 2) private BigDecimal whealDiameterMm;
    @Column(name = "QTY_FLARE_DIAM_MM", precision = 8, scale = 2) private BigDecimal flareDiameterMm;
    @Column(name = "DES_REACT_DESCR", length = 1000) private String reactionDescription;
    @Column(name = "DES_EARLY_READ_REASON", length = 1000) private String earlyReadReason;
    @Column(name = "ID_USER_PRFRMD", nullable = false) private Long performedByUserId;
    @Column(name = "ID_PRACT_PRFRMD") private Long performedByPractitionerId;
    @Column(name = "ID_USER_READ") private Long readByUserId;
    @Column(name = "ID_PRACT_READ") private Long readByPractitionerId;
    @Column(name = "ID_USER_VRFD") private Long verifiedByUserId;
    @Column(name = "ID_PRACT_VRFD") private Long verifiedByPractitionerId;
    @Column(name = "NA_PRACT_VRFD", length = 160) private String verifiedByName;
