    ...
    public List<Source> sources() {
        ...
        return List.of(
            ...
            new Source("DIAGNOSIS",1,"门诊确诊记录","每条本次就诊有效确诊记录一行",
                ...
                "e.SD_ENC_CLASS='OUTPATIENT' and d.SD_DIAG_STAGE='ENCOUNTER' and d.SD_DIAG_STATUS='ACTIVE' and d.SD_VERIFICATION_STATUS='CONFIRMED'","d.DT_RECORDED",
            ...
            new Source("ORDER",1,"门诊医嘱","每条医嘱一行，不是处方张数或药品数量",
                ...
                "e.SD_ENC_CLASS='OUTPATIENT' and r.SD_REQ_KIND in ('MEDICATION','SERVICE')","r.DT_AUTHORED",
