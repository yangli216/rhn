...
public class Settlement {
    ...
    @Column(name = "ID_STL_RVRS") private Long reversesSettlementId;
    ...
    @Column(name = "AMT_RND", nullable = false, precision = 24, scale = 6) private BigDecimal roundingAmount;
    ...
    @Column(name = "ID_USER_FNLZD") private Long finalizedBy;
    @Column(name = "DT_FNLZD") private Instant finalizedAt;
