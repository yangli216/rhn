...
public class PaymentOrder {
    ...
    @Column(name = "ID_PAY_ORIG") private Long originalPaymentId;
    ...
    @Column(name = "SD_BIZ_SCENE", nullable = false) private String businessScene;
    ...
    @Column(name = "AMT_REQD", nullable = false, precision = 24, scale = 6) private BigDecimal requestedAmount;
    @Column(name = "AMT_CAPTD", nullable = false, precision = 24, scale = 6) private BigDecimal capturedAmount;
    @Column(name = "AMT_RFNDD", nullable = false, precision = 24, scale = 6) private BigDecimal refundedAmount;
