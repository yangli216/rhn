...
- 2026-09-20 标准建设迭代：[标准目录与用药语义运行契约](标准目录与用药语义运行契约.md)（建档约束、频次/剂量语义、新版重复规则及 AI 边界）
- 当前核心验收：[重复用药与相互作用](首轮核心业务验收-重复用药与相互作用.md)（两条有来源样例、18 个运行场景及开方/审方操作路径，待业务验收）

- 2026-09-21 标准目录核对：[实际数据修复与剩余清单](标准目录核对与建设结果-2026-09-21.md)（2209 条档案核对、剂型修正与可用身份关联）

- 2026-09-22 标准建设落地：[业务档案关联、浓度换算与剩余缺口](标准建设落地结果-2026-09-22.md)（1979 条有效关联，33 条错误导入片段暂停，实际业务产品接入）。

- 2026-09-22 业务样例重建：[旧药品清理与5个标准产品](标准药品业务样例重建-2026-09-22.md)（14/14业务产品关联有效，开方可选、库存核对通过）。

- 2026-09-23 剩余缺口治理：[标准药品剩余缺口治理](标准药品剩余缺口治理-2026-09-23.md)（1958 条标准关联、247 条不安全历史记录退役、4 条机构补充标准待建）。
...
- [QMED-0 运行基础与 QMED-1 接入验收（2026-09-16）](QMED-0与QMED-1接入验收.md)

- [QMED-0 与远程规则工作台合并记录（2026-09-17）](远程合并记录-2026-09-17.md)

- [统一在行规则目录与发布治理](标准目录与用药语义运行契约.md#统一在行规则目录与发布治理)
- [标准化、规则知识库与 AI 建设里程碑（2026-09-21）](标准与AI知识建设里程碑-2026-09-21.md)

- [知识编译为规则候选与统一目录接入](标准与AI知识建设里程碑-2026-09-21.md#第十一轮交付知识编译为规则候选并纳入统一目录)

- [人工验证样例、版本与执行留痕](标准与AI知识建设里程碑-2026-09-21.md#第十二轮交付人工验证样例版本与执行留痕)

- [知识候选职责分离审核与固定材料](标准与AI知识建设里程碑-2026-09-21.md#第十三轮交付知识候选的职责分离审核与固定材料)

- [知识候选的科室旁路部署与观察](标准与AI知识建设里程碑-2026-09-21.md#第十四轮交付知识候选的科室旁路部署与观察)

- [AI 需求分析、澄清与知识起草入口](标准与AI知识建设里程碑-2026-09-21.md#第十五轮交付ai-需求分析澄清与知识起草入口)

- [标准关联修订的冻结影响清单与变化复核](标准与AI知识建设里程碑-2026-09-21.md#第十六轮交付标准关联修订的冻结影响清单与变化复核)。

- [旁路观察的人工研判与反馈追溯](标准与AI知识建设里程碑-2026-09-21.md#第十七轮交付旁路观察的人工研判与反馈追溯)。

- [知识候选独立正式启用、暂停与回退](标准与AI知识建设里程碑-2026-09-21.md#第十八轮交付知识候选独立正式启用暂停与回退)。

- [旁路反馈进入 AI 改进需求与知识新版本](标准与AI知识建设里程碑-2026-09-21.md#第十九轮交付旁路反馈进入-ai-改进需求与知识新版本)。

- [标准目录版次登记、运行归档与字段差异](标准与AI知识建设里程碑-2026-09-21.md#第二十轮交付标准目录版次登记运行归档与字段差异)。

### 2026-09-23 标准目录逐条转录核对

国家基本药物目录（2026年版）核对工作台按电子条目的 `pdfLocations` 自动定位已校验指纹的官方 PDF。单条“核对无误”无需录入理由；“有问题”必须记录说明，保存成功后继续下一条，失败保留当前条目与输入。来源材料和双人来源审批保留在独立的来源管理入口。

逐条结果写入 `RHN_BD_ENTRY_REVIEW` 不可变事件，以租户、完整目录身份和条目标识隔离，递增序号处理并发冲突。该结果仅记录转录核对，不改变整本目录的来源审批状态、规格临床审核或药品可用性。当前仅支持已登记指纹的 2026 官方 PDF，其他来源不自动套用此原稿。
