...
function generateSql(isOracle = false) {
  ...
  lines.push(
    `insert into RHN_BD_CODE_SYSTEM (ID_CODE_SYSTEM, SD_SCOPE_TYPE, ID_SCOPE, CD_CODE_SYSTEM, NA_CODE_SYSTEM, CD_CANON_URI, CD_VER, SD_STATUS, DA_EFF_FROM, DA_EFF_TO, DT_CREATED, SD_SYS_TYPE, PUBLSHR, DES_CODE_SYSTEM, SD_SRC_TYPE, REVISION, DT_UPDATED, SD_AUTHRTY_TYPE, CD_SRC_URI, HASH_CONTENT, SD_DIAG_DOMAIN)`,
  ...
  for (const item of diseases) {
    ...
    lines.push(
      `insert into RHN_BD_CONCEPT (ID_CONCEPT, ID_CODE_SYSTEM, CD_CONCEPT, NA_DISPLAY, DES_DEF, SD_STATUS, DA_EFF_FROM, DA_EFF_TO, DT_CREATED, SD_CONCEPT_TYPE, NA_SHORT, CD_CHAPTER, NA_CHAPTER, CD_SEARCH, SD_SRC_TYPE, ID_CONCEPT_RPLCMNT, REVISION, DT_UPDATED)`,
  ...
  lines.push(
    ...
    `insert into RHN_HPL_DISEASE_MGMT_PROG (ID_DISEASE_MGMT_PROG, REVISION, SD_SCOPE_TYPE, ID_SCOPE, CD_DISEASE_MGMT_PROG, NA_DISEASE_MGMT_PROG, SD_MGMT_TYPE, SD_TRIGGER_ACTION, DES_DISEASE_MGMT_PROG, SD_REPORT_CARD_TYPE, QTY_REPORT_DDLN_HOURS, SD_STATUS, DA_EFF_FROM, DA_EFF_TO, DT_CREATED, DT_UPDATED)`,
  ...
  lines.push(
    "",
    `insert into RHN_HPL_DISEASE_MGMT_MEMBER (ID_DISEASE_MGMT_MEMBER, ID_DISEASE_MGMT_PROG, ID_CONCEPT, SD_STATUS, DA_EFF_FROM, DA_EFF_TO, DES_NOTE, DT_CREATED, SD_INCL_MODE)`,
    ...
    "",
    `insert into RHN_HPL_DISEASE_MGMT_RULE (ID_DISEASE_MGMT_RULE, ID_DISEASE_MGMT_PROG, SD_INCL_MODE, SD_DIAG_DOMAIN, ID_CODE_SYSTEM, SD_CONCEPT_TYPE, CD_CHAPTER, CD_CODE_FROM, CD_CODE_TO, DES_NOTE, DT_CREATED)`,
