...
const jsonPath = path.join(root, "docs/essential-drugs/essential_drugs_2026.json");
const csvPath = path.join(root, "docs/essential-drugs/国家基本药物目录（2026年版）_药品基本信息导入表.csv");
const pgSqlPath = path.join(root, "backend/src/main/resources/db/migration/V1_47_0__national_essential_medications_2026.sql");
const oraSqlPath = path.join(root, "backend/src/main/resources/db/oracle/V1_47_0__national_essential_medications_2026.sql");
